-- ================================================
-- Table 4: payment_history (FRESH START)
...
CREATE INDEX idx_payment_user_id ON public.payment_history(user_id);
CREATE INDEX idx_payment_email ON public.payment_history(email);
CREATE INDEX idx_payment_subscription_id ON public.payment_history(subscription_id);
CREATE INDEX idx_payment_status ON public.payment_history(payment_status);
CREATE INDEX idx_payment_date ON public.payment_history(payment_date);
CREATE INDEX idx_payment_stripe_id ON public.payment_history(stripe_payment_id);
