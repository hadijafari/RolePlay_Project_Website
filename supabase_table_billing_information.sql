...
-- Policy 1: Users can view their own billing information
CREATE POLICY "Users can view own billing info"
    ON public.billing_information
    FOR SELECT
    USING (auth.uid() = user_id);

-- Policy 2: Users can insert their own billing information
CREATE POLICY "Users can insert own billing info"
    ON public.billing_information
    FOR INSERT
    WITH CHECK (auth.uid() = user_id);

-- Policy 3: Users can update their own billing information
...
-- Policy 4: Users can delete their own billing information
